...
Wie in Tabelle \ref{tab: googleAnalyticsFeatures} ersichtlich ist, bietet Google Analytics eine Riesige Menge an Funktionalität, gute Visualisierungen und ist trotzdem Gratis. Dies ist für Anwender, darunter eine Verwaltung die an der Umfrage (siehe Anhang \ref{appendix:umfrage}) teilgenommen hat, ein Grund sich für Google Analytics zu entscheiden. 
...
\begin{table}[h]
	...
	\end{tabular}
	\caption{Google Analytics - Durchschnittliche Bewertung der Eigenschaften \parencite{softwareProcurementEvaluationTable} gemäss Umfrage (siehe Anhang \ref{appendix:umfrage})}
...
Matomo bietet ähnliche Funktionen (Vgl. Tabelle \ref{tab: MatomoFeatures}) an wie Google Analytics \ref{subsec:GoogleAnalytics}. Einzig über die Berichterstellung werden bei Matomo kaum Features genannt, ausser dass Benutzerdefinierte Performanceberichte erstellt werden können \parencite{MamotoFeatures}. 
...
\begin{table}[h]
	...
	\end{tabular}
	\caption{Matomo - Durchschnittliche Bewertung der Eigenschaften \parencite{softwareProcurementEvaluationTable} gemäss Umfrage (siehe Anhang \ref{appendix:umfrage})}
...
\begin{table}[h]
	...
	\end{tabular}
	\caption{i-CMS Webanalysetool - Durchschnittliche Bewertung der Eigenschaften \parencite{softwareProcurementEvaluationTable} gemäss Umfrage (siehe Anhang \ref{appendix:umfrage})}
