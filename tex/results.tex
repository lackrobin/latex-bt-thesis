...
Zusätzlich zum Bundesgesetz für Datenschutz, unterliegen Verwaltungen dem jeweiligen kantonalen Datenschutzgesetz.

Der Kanton Bern erlaubt gemäss \parencite[§§ 15 Abs. 1]{DSSGBERN} das Bearbeiten der Daten für Forschung, Praxisbildung, \bf{Statistik} oder Planung, sofern die Daten anonymisierten oder ohne direkte Personenkennzeichnung verwendet werden.




\subsection{Datenschutz Strategien}
