...
\newpage
Für die verwendeten Kriterien wurde im Kapitel \ref{sec:marktangebotwebanalyse} die Grundlage gelegt. Als Kriterien und deren Subkriterien gelten:

\begin{itemize}
  \item Service \begin{itemize}
    \item Affordability
    \item Supportability
    \item Service
    \item Changeability
  \end{itemize}
  \item Zugänglichkeit \begin{itemize}
    ...
    \item Accessibility
  \end{itemize}
  \item Datensicherheit \begin{itemize}
    \item Datenschutz
    \item Datenhoheit
    \item Datenzugriff
    \item Identity
...
Da sich die Wichtigkeit der Kriterien von Organisation zu Organisation unterscheiden, werden für die nachfolgenden Berechnungsbeispiele der Kriterien Schauzahlen verwendet. Die Zahlen der Gegenüberstellung der Tools leitet sich aus den Ergebnissen der Umfrage (siehe Anhang \ref{appendix:umfrage}) ab. 
...
\begin{table}[h]
	\centering
\begin{tabular}{ccccc}
  & Service & Zugänglichkeit & Datensicherheit & Datenverarbeitung \\
  Service & 1 & 2 & 0,5 & 2 \\
  Zugänglichkeit & 0,5 & 1 & 0,5 & 2 \\
  Datensicherheit & 2 & 2 & 1 & 2 \\
  Datenverarbeitung & 0,5 & 0,5 & 0,5 & 1 \\
  SUM & 4 & 5,5 & 2,5 & 7 \\
  \end{tabular} 
